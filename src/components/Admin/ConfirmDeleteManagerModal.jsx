...
import { removeManager } from "../../services/Manager/ManagerService";




const ConfirmDeleteManagerModal = ({ isOpen, onClose, manager, setIsReload }) => {
    console.log(manager);
            ...
            <div className="p-6 bg-white rounded shadow-lg w-full">
                ...
                <div className="mt-4 text-center">
                    <p className="text-xl text-gray-700 font-bold">
                        Bạn chắc chắn muốn xóa quản lý này không?
                    </p>
                </div>
...
export default ConfirmDeleteManagerModal;
