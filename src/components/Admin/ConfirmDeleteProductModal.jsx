...
const ConfirmDeleteProductModal = ({ isOpen, onClose, product, setIsReload }) => {
            ...
            <div className="p-6 bg-white rounded shadow-lg w-full">
                ...
                <div className="mt-4 text-center">
                    <p className="text-xl text-gray-700 font-bold">
                        Bạn chắc chắn muốn xóa sản phẩm {product.productName} ({product.color} - {product.size} - {product.condition}) không?
                    </p>
                </div>
