  ...
  const handleSaveDescription = async () => {
    ...
    try {
      const response = await fetch(
        `https://capstone-project-703387227873.asia-southeast1.run.app/api/Product/edit-description-of-product/${productCode}?description=${encodeURIComponent(description)}`,
        {
          method: 'PUT',
          headers: {
            'Accept': '*/*',
      ...
      if (response.ok) {
        alert("chỉnh sửa mô tả thành công!");
        setEditorContent("")
      } else {
  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      <div className='bg-white border border-gray-300 shadow-md rounded-lg p-6'>
        ...
        {selectedProduct && (
          <div className="mt-6">
            <h4 className="text-lg font-medium text-gray-700 mb-2">Product Description</h4>
            <Editor
